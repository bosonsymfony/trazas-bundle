...
/**
 * Class hisExcepcionRepository. Repositorio de funcionaliades de acceso a datos para la tabla his_excepcion
 *
 * @author Daniel Arturo Casals Amat<dacasals@uci.cu>
 * @package UCI\Boson\TrazasBundle\Repository
 */
class hisExcepcionMongoDBRepository extends DocumentRepository  {

    /**
     * Devuelve un array con las trazas de excepción registradas entre el inicio y el límite especificado.
    ...
    public function findByLimit( $start, $limit) {
        ...
        $qb = $this->dm->getRepository('TrazasBundle:hisExcepcion')->createQueryBuilder('trazas');
        $qb->skip($start)
            ->limit($limit);
    ...
    /**
     * Devuelve un array con las trazas de excepción registradas entre la fecha de inicio y fin especificado.
    ...
    /**
     * Devuelve un array con las trazas de excepción registradas entre las fechas de inicio y fin especificadas, teniendo en cuenta el inicio y límite especificado.
